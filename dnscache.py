...
bl_df= pd.read_csv("C:/Users/GPK/Downloads/DNS Filtering System/DNS Filtering System/DNS Resolver Server/blacklist.csv",usecols=['domain'])
wl_df= pd.read_csv("C:/Users/GPK/Downloads/DNS Filtering System/DNS Filtering System/DNS Resolver Server/whitelist.csv",usecols=['domain'])
